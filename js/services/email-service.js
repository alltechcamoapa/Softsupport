        ...
        try {
            ...
            if (typeof emailjs !== 'undefined' && config.publicKey !== 'YOUR_PUBLIC_KEY' && config.enabled) {
                ...
                const templateParams = {
                    ...
                    subject: subject,
                    message: body,
                    from_name: options.fromName || 'ALLTECH SUPPORT',
        ...
        const templates = {
            'contrato_creado': {
                ...
                body: `
                    ...
                    <br>
                    <p>Saludos cordiales,<br><strong>ALLTECH SUPPORT</strong></p>
                `
            },
            'visita_programada': {
                ...
                body: `
                    ...
                    <br>
                    <p>Saludos,<br><strong>ALLTECH SUPPORT</strong></p>
                `
            },
            'proforma_enviada': {
                ...
                body: `
                    ...
                    <br>
                    <p>Atentamente,<br><strong>ALLTECH SUPPORT</strong></p>
                `
            },
            'recordatorio_pago': {
