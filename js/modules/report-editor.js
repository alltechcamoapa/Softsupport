        ...
        contratos: {
            ...
            sections: {
                ...
                footer: {
                    ...
                    elements: [
                        { id: 'el28', type: 'text', x: 20, y: 20, content: 'ALLTECH - Sistema de Gestión de Soporte Técnico | Camoapa, Nicaragua', styles: { fontSize: '10px', color: '#666' } },
        ...
        equipos: {
            ...
            sections: {
                ...
                footer: {
                    ...
                    backgroundColor: '#f5f5f5',
                    elements: [
                        { id: 'el11', type: 'text', x: 20, y: 15, content: 'ALLTECH - Sistema de Gestión | Camoapa, Nicaragua', styles: { fontSize: '10px', color: '#666' } }
                    ]
                }
            }
        },
        proformas: {
            ...
            sections: {
                ...
                footer: {
                    ...
                    backgroundColor: '#f5f5f5',
                    elements: [
                        { id: 'el20', type: 'text', x: 20, y: 15, content: 'ALLTECH - Sistema de Gestión de Soporte Técnico', styles: { fontSize: '10px', color: '#666' } },
