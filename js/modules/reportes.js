...
const ReportesModule = (() => {
  ...
  const generateInventoryReport = () => {
    ...
    const content = `
      <div class="header">
        <h1>Catálogo General de Productos y Servicios</h1>
  ...
  const printReport = (title, content) => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ${content}
        <div class="footer">
          <p>Soporte Técnico ALLTECH - Sistema de Gestión Cloud</p>
  ...
  const generateGeneralReport = () => {
    ...
    const content = `
      <div class="header">
        <h1>Reporte de Actividades y Visitas</h1>
